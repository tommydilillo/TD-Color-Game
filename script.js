...
Game.prototype.movePlayer = function(clickedKey) {
  ...
  switch (clickedKey) {
    case 37: // console.log("LEFT");
      ...
      if (xInnerBoundary && this.virtualCanvas.virtualPlayerX > this.player.r) {
        this.player.x -= 20;
...
function startGame() {
  ...
  // console.log("OBSTACLES ", currentGame.obstacles[0]);
...
Game.prototype.updateCanvas = function() {
  ...
  for (var i = 0; i < currentGame.obstacles.length; i++) {
    // CREATE BOUNDARIES AND OBSTACLE MOVEMENTS WHEN THEY MEET BOUNDARY --------------
    ...
    //-------------------CHECKS COLLISSIONS-------------------
    // SAME COLOR COLLISION: +1 point and splice obstacle.
    if (
    ...
    //  DIFFERENT COLOR COLLISION: End Game
